...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/resq_dashboard?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/resq_dashboard/badge)](http://codestats-url/organizations/your-organization/projects/resq_dashboard/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/resq_dashboard.git`
- Go to the project root by running `cd resq_dashboard`
...
```bash
  ...
  CREATE ROLE "resq_dashboard" LOGIN CREATEDB PASSWORD 'resq_dashboard';
```
